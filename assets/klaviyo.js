...
(function() {
                        ...
                        if (window._learnq && _learnq.identify) {
                            ...
                            if (d && (d = d.$email || d.email)) {
                                if (b["if"]) {
                                    var g = jQuery(b["if"]);
                                    if (!g.length ||
                                        (g.is(":checkbox") ? !g.is(":checked") : !g.val())) {
                            ...
                            success: function(c, e, g) {
                                ...
                                c.success ? (KlaviyoSubscribe.setClosedModalCookie(), e = a.find(".success_message").show(), successSubmit = true, e.length || (e = a.parent().find(".success_message").show()), window._learnq &&
                                    _learnq.push && (g = a.find('[name="email"]').val()) && (_learnq.push(["identify", {
                                        ...
                                        a.find(".klaviyo_field_group").hide()), b.success && b.success(a, c.data), a.trigger("klaviyo.subscribe.success").resetForm())) : (KlaviyoSubscribe.log(c.errors), a.find(".error_message").show().html(c.errors.join(" ")), a.trigger("klaviyo.subscribe.error"))
                            }
                        });
   ...
   KlaviyoSubscribe.setClosedModalCookie()
        ...
        KlaviyoSubscribe._buildFlyoutSignUp = function(a) {
            var b = a.content;
            if (b.element) return jQuery(b.element);
            var c = jQuery(m[a.include_form ? "flyout_form.html" : "flyout.html"]).attr("id", "k_id_flyout").find(".klaviyo_header").html(b.header ||
            ...
            b.clazz && c.addClass(b.clazz);
            b.styles && KlaviyoSubscribe.injectCSS(b.styles);
            !1 !== b.subheader && c.find(".klaviyo_subheader").html(b.subheader ||
        ...
        KlaviyoSubscribe.attachToFlyout = function(a, b) {
            ...
            b.extra_properties.$source = b.extra_properties.$source ||
                "$flyout";
            KlaviyoSubscribe.bootstrap();
            KlaviyoSubscribe.setHasClosedModalCookieName(b.has_closed_modal_cookie_name);
            KlaviyoSubscribe.executeWhenRequirementsLoaded(function() {
        ...
        KlaviyoSubscribe.isFormValid = function(a) {
            ...
            a.find(".select-date-widget").each(function(a, b) {
                ...
                var e = KlaviyoSubscribe._int(b.find('[name$="_day"]').val()),
                    ...
                    k =
                    KlaviyoSubscribe._int(b.find('[name$="_year"]').val());
                if (!(isNaN(e) || isNaN(f) || isNaN(k))) {
                    ...
                    KlaviyoSubscribe.log("Invalid date", k, f, e);
                    throw "Invalid date";
                }
            });
            return !0
        ...
        KlaviyoSubscribe.hasClosedModal = function() {
            return !!KlaviyoSubscribe._getCookie(h) &&
                !KlaviyoSubscribe.isDebugMode()
        };
